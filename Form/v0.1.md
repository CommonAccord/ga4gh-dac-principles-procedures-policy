...
2.4.0.2.sec=Items that may be addressed in Terms of Reference include: 
...
2.5.1.5.sec=Terms of consensus for {_DAC} decisions (e.g. unanimity, majority);
...
2.6.1.3.sec=Justification for data access;
...
2.6.2.1.0.sec=The application includes a summary of the research project in plain language that addresses, among others: 

2.6.2.1.1.sec=what is the research question and why is it important?

2.6.2.1.2.sec=how will the participants'/data subjects' data be used to investigate the research question?

2.6.2.1.3.sec=what is the method, in plain language? and

2.6.2.1.4.sec=what are the potential benefits or implications of the proposed research (including both short-term outcomes and longer-term impact)?
...
2.7.1.2.sec=The number of access requests, both approved and denied, and the average length of time from user submission to {_DAC} decision, demonstrating transparency in {_DAC} review performance;
